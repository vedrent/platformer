...
int main(int argv, char **args) {
    ...
    character = Character(karlson, 0, SCREEN_HEIGHT / 2 - CHARACTER_HEIGHT / 2, CHARACTER_WIDTH, CHARACTER_HEIGHT);
    ...
    while (!quit) {
        ...
        // ENEMY
        enemy.Move(level, const_cast<Uint8 *>(state), character.GetXPerFrame());
